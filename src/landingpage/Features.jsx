...
<div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 pb-20">
    <div className="md:w-2/3 lg:w-1/2">
      ...
      <p className="text-gray-600 dark:text-gray-300 text-lg">Job Search Revolution: AI-Powered Success at Your Fingertips! Discover Streamlined Search, Resume Wizardry, Cover Letter Mastery, and Interview Excellence. Leverage OpenAI(gpt) and Claude to Supercharge Your Journey towards Landing Your Dream Job. Experience the Future of Job Hunting Today!</p>
    </div>
    <div
        ...
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Craft a winning resume that stands out from the competition. Our AI tools, OpenAI(gpt) and Claude, provide expert guidance to optimize your resume for success.
            </p>
          </div>
        </div>
      </div>
...
Say Goodbye to Writer's Block: Let AI Generate Winning Cover Letters!
            ...
            <p className="text-gray-600 dark:text-gray-300">Elevate your application with persuasive cover letters generated by our AI assistants, OpenAI(gpt) and Claude. Impress employers with personalized and compelling introductions.</p>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
Prepare for interviews like a pro with our AI-powered tools. OpenAI(gpt)and Claude offer interactive question and answer sessions to help you confidently ace any job interview.Prepare for interviews with our AI-powered tools.            </p>
          </div>
        </div>
      </div>
    </div>
