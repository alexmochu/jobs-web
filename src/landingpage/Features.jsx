      ...
      <div className='mt-16 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4'>
        <div className='group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10'>
          <div className='relative space-y-8 py-12 p-8'>
            ...
            <div className='space-y-2'>
              <h5 className='text-gray-700 font-semibold  text-lg dark:text-white transition group-hover:text-secondary text-left'>
        ...
        <div className='group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10'>
          <div className='relative space-y-8 py-12 p-8'>
            ...
            <div className='space-y-2'>
              <h5 className='text-left text-lg font-semibold text-gray-700 dark:text-white transition group-hover:text-secondary'>
