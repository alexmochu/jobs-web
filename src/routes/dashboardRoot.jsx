...
<aside id="logo-sidebar" className={`fixed overflow-y top-0 left-0 z-40 ${isOpen ? 'w-16' :'w-64'} h-screen pt-3 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`} aria-label="Sidebar">
      ...
      <ul className="space-y-2 font-medium">
         ...
         <Link
          ...
          <Link
              ...
              aria-current={'page'}
              className="flex items-center p-2 pb-8 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
