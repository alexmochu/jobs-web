...
export default function JobsDashboard() {
  ...
  return (
    <div className='pl-5 pr-5 dark:bg-gray-800'>
      ...
      <div id='myTabContent'>
        <div
          className={tabState === 'search' ? 'p-4 rounded-lg dark:bg-gray-800' : 'hidden'}
          id='profile'
          role='tabpanel'
        ...
        <div
          className={tabState === 'tracker' ? 'pb-4 rounded-lg dark:bg-gray-800' : 'hidden'}
          id='dashboard'
          role='tabpanel'
