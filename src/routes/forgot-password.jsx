                  ...
                  <label className="block">
                    ...
                    <input
                      ...
                      className={`mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                            ...
                            focus:invalid:border-pink-500 focus:invalid:ring-pink-500  ${error ? 'border-red-500' : ''}`}
                    />
                    {error && <span className="block text-left text-sm font-medium text-red-700">{error}</span>}
                  </label>
                  <label className="block">
