                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        className={`mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                            ...
                            focus:invalid:border-pink-500 focus:invalid:ring-pink-500  ${error.email ? 'border-red-500' : ''}`}
                      />
                      {error.email && <span className="block text-left text-sm font-medium text-red-700">{error.email}</span>}
                    </label>
                    <label className="block mt-2">
                      ...
                      <input 
                        ...
                        className={`mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                            ...
                            disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                            invalid:border-pink-500 invalid:text-pink-600
                            focus:invalid:border-pink-500 focus:invalid:ring-pink-500 ${error.username ? 'border-red-500' : ''}`}
                      />
                      {error.username && <span className="block text-left text-sm font-medium text-red-700">{error.username}</span>}
                    </label>
                    <label className="block mt-2">
                      ...
                      <input 
                        ...
                        className={`mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                            ...
                            disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                            invalid:border-pink-500 invalid:text-pink-600
                            focus:invalid:border-pink-500 focus:invalid:ring-pink-500 ${error.password ? 'border-red-500' : ''}`}
                      />
                      {error.password && <span className="block text-left text-sm font-medium text-red-700">{error.password}</span>}
                    </label>
                    <label className="block">
