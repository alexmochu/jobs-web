...
//             <path d='M10 12.586L4.707 7.293a1 1 0 011.414-1.414L10 10.172l3.879-3.879a1 1 0 011.414 1.414L10 12.586z' />
//           </svg>
//         </button>
//       </div>
//       {isOpen && (
...
//         >
//           <div
//             className='px-4 py-3 bg-white rounded-md shadow-xs'
//             aria-labelledby='dropdown-button'
//             role='menu'
//           >
//             <p className='text-sm leading-5 text-gray-700 mb-2'>Some text here:</p>
//             <input
//               type='text'
...
//             <button
//               type='button'
//               className='w-full px-4 py-2 text-sm leading-5 text-white transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700'
//             >
//               Submit
//             </button>
//           </div>
