                ...
                <div className='w-full grid grid-cols-10'>
                  ...
                  <div className='items-left col-span-7'>
                    <div className='text-sm'>
                      ...
                      <RadioGroup.Description as='span' className={`flex mt-2 pr-3 ${'text-gray-800'}`}>
                        <span>{'Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto laboriosam deleniti aperiam ab veniam sint non cumque quis tempore tapasas cupiditate...'
                        }</span>
